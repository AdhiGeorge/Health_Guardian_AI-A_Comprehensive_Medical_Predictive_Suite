...
# Load the dataset
data = pd.read_csv(r"D:\SACAIM\Digital Health Assistant\DHA datasets\alzheimers_disease_data.csv")  # Replace with your dataset file name
...
with open('alzheimersPrediction.sav', 'wb') as f:
